...
echo ""
echo "Para detener backend y frontend (mata lo que esté escuchando en el puerto, no el PID del wrapper):"
echo "  sudo fuser -k 8080/tcp   # backend"
echo "  sudo fuser -k 5173/tcp   # frontend (ajusta el puerto si tu vite.config.js usa otro)"
